...
namespace biiuse
{
    ...
    {
        private Trade context; //hides context in Trade

        public BuyLimitOrderOpened(Trade aContext, MqlApi mql4) : base(mql4)
        {
        ...
        public override void update()
        {
            ...
            {
                context.addLogEntry(2, "Ask price went above cancel level");
